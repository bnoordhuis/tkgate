...
//: enddecls
  ...
  //: SWITCH g3 (w0) @(340,39) /sn:0 /w:[ 0 ] /st:0
  //: joint g13 (w1) @(394, 73) /w:[ 2 4 1 6 ]
  _GGOR2 #(6) g34 (.I0(w3), .I1(w4), .Z(co));   //: @(216,139) /sn:0 /w:[ 0 0 1 ] /eb:0
  //: LED g55 (w0) @(431,22) /sn:0 /w:[ 5 ] /type:0
  REGS g2 (.SA(w21), .AIN(w12), .AOUT(w14), .SB(w23), .BOUT(w30), .ck(w33));   //: @(165, 479) /symbol:689601296 /sn:0 /w:[ 0 0 0 0 0 0 ]
  ...
  //: DIP sa (w21) @(52,428) /R:1 /w:[ 1 ] /st:0
  ...
  //: DIP sb (w23) @(52,478) /R:1 /w:[ 1 ] /st:1
  //: DIP func (w26) @(52,331) /R:1 /w:[ 0 ] /st:0
  ...
  //: SWITCH data_select (w28) @(52,268) /w:[ 0 ] /st:0
  ...
  //: SWITCH g12 (w1) @(340,73) /sn:0 /w:[ 0 ] /st:0
...
//: /netlistBegin ALU
module ALU(F, A, B, Z);
//: interface  /sz:(89, 65) /bd:[ Ti0>B[7:0](67/89) Ti1>A[7:0](21/89) Li0>F[1:0](39/65) Bo0<Z[7:0](44/89) ]
