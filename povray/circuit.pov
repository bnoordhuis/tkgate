...
#declare Paper =
  union {
    ...
    union {    
      union {
        object { text { ttf "cyrvetic.ttf" "Name: beak" 0.03, 0 } scale .3 }
	translate <-.9, 1.3,-0.02>

      }
      union {
        object { text { ttf "cyrvetic.ttf" "File: beak.v" 0.03, 0 } scale .3 }
	translate <-.9, 1,-0.02>
      }
      union {
        object { text { ttf "cyrvetic.ttf" "Ver.:  2.0" 0.03, 0 } scale .3 }
	translate <-.9, 0.7,-0.02>
      }
      union {
        object { text { ttf "cyrvetic.ttf" "Change Warn:  Yes" 0.03, 0 } scale .3 }
	translate <-.9, 0.4,-0.02>
      }
      union {
        object { text { ttf "cyrvetic.ttf" "Ext Bar:  Yes" 0.03, 0 } scale .3 }
	translate <-.9, 0.1,-0.02>
      }
...
#declare Circuit =
  union {
    ...
    union {
      ...
      // Outputs
      box { <0, -0.05, 0.001>, <1, 0.05, 0.05> translate <1.13,1,0> texture { Bus_Text }} 
      box { <0, -0.05, 0.001>, <1, 0.05, 0.05> translate <1.13,-.4,0> texture { Bus_Text }} 
      ...
      box { <1, -0.0355, 0.001>, <2.5, 0.035, 0.035> translate <-2.2,-.5,0> texture { Wire_Text }} 
...
object { Circuit }
//object { Paper rotate x*20 rotate y*10 translate <-0.5,0.5,-1>}
